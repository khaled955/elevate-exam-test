...
import { createNewPasswordSchema, forgetPasswordSchema, VerifyOtpSchema } from "../schemes/forget-schema";
...
export type CreateNewPasswordPayload =Omit<CreateNewPasswordFormValues,"rePassword"> & {
  email:string;
};
